...
Prior to my current role, I spent six years in industry working on speech processing, where I pioneered self-supervised learning approaches for speech (like masked predictive coding <a href="/publications/#DBLP:journals/corr/abs-1910-09932">[7]</a> and Speech SimCLR <a href="/publications/#DBLP:conf/interspeech/JiangLCZL21">[8]</a>) and was among the first to deploy end-to-end ASR systems at production scale. Following the release of ChatGPT, I became deeply interested in foundation models and their potential, which motivated me to return to academia and complete my master's degree at JHU. There, I worked with Professor [Daniel Khashabi](https://danielkhashabi.com/) and [Benjamin Van Durme](https://www.cs.jhu.edu/~vandurme/), and also collaborated with Professor [Shay Cohen](https://homepages.inf.ed.ac.uk/scohen/) from Edinburgh, [Greg Durrett](https://www.cs.utexas.edu/~gdurrett/) from NYU, and [Dawn Song](https://dawnsong.io/) from UC Berkeley on various research projects. Currently, I'm working as an Applied Scientist at Amazon, where I continue to pursue research in foundation models and related areas.

Throughout my journey, I've been fortunate to receive incredible mentorship and support from many people. If I can be of service—whether you want to chat about research, navigate career transitions, or anything else—feel free to <a href="https://calendar.app.google/BewYXJYPcTGveKRX6">book time on my calendar</a>.
